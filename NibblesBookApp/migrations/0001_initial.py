# Generated by Django 2.2.1 on 2019-10-04 20:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='NibblesBookApp.Author')),
            ],
        ),
        migrations.CreateModel(
            name='Publisher',
        ...
        migrations.AddField(
            model_name='book',
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='NibblesBookApp.Publisher'),
        ),
        migrations.AddField(
            model_name='book',
            name='store',
            field=models.ManyToManyField(to='NibblesBookApp.Store'),
        ),
    ]
